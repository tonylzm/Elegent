...
<div class="sidebar" >
    <div class="header"><img src="views/images/主页.png" class="round_icon">欢迎您，<%= username %>！</div>
    <a href="#" class="active"><img src="views/images/拼团.png">拼团</a>
    <div class="dropdown">
        <a href="#" class="dropdown-toggle"><img src="views/images/菜单管理.png">我的活动</a>
        <div class="dropdown-content">
            <a href="#" class="dropdown-toggle" onclick="creatPopup()"><img src="views/images/我管理的.png">我发起的拼团</a>
            <a href="#" onclick="joinPopup()"><img src="views/images/我参加的.png">我加入的拼团</a>
            <a href="#" onclick="managePopup()"><img src="views/images/加入.png">管理拼团人员</a>
        </div>
    </div>
    <a href="#" onclick="invitePopup()"><img src="views/images/加入.png">加入拼团</a>
    <a href="#" onclick="quit()"><img src="views/images/退出.png">推出拼团</a>
</div>
</div>
